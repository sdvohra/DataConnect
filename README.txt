Contains some of the HTML code used to build UC Berkeley's official DataConnect website, found at dataconnect.berkeley.edu. Made with the help of HTML5 UP:
